 ...
 * #L%
 */
package me.christallinqq.penisqueue.bukkit;

import net.md_5.bungee.api.ChatColor;
import org.bukkit.World;
import org.bukkit.plugin.java.JavaPlugin;

public final class PenisQueueBukkit extends JavaPlugin {
    ...
    public void onEnable() {
        getLogger().info(ChatColor.BLUE + "PenisQueue V" + getDescription().getVersion());
